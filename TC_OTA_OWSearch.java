...
public class TC_OTA_OWSearch  extends DriverSetup {
	...
	@Test(dataProvider = "TC_OTA_OWSearch")
	public void ApplyHandlingFeeRule(String URL)
		...
		try{
			...
			//test  = extent.startTest("OTA-OW Search");	
		    ...
		    test.log(LogStatus.PASS, "Listing page of OW");
...
test  = extent.startTest("OTA-OW Search");	
		...
		{
			System.out.println("Unexpected error occured during appending OW search");
		e.printStackTrace();
		test.log(LogStatus.FAIL, "Unexpected error occured during appending OW search");   
		}
	}
