...
public class TC_SA_Time_Bar_Departure  extends DriverSetup {
	...
	@DataProvider(name = "TC_SA_Time_Bar_Departure")
	...
	@Test(dataProvider = "TC_SA_Time_Bar_Departure")
	...
	Thread.sleep(2000);
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking timebar link", "Clicking on Time bar link ", true, "Same as Expected", "Time bar link is clickable", "Time bar link should be clickable");
	...
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking for onward segment", "Clicking on onward segment ", true, "Same as Expected", "Onward segment is selected", "Onward segment should be selected");
	...
	Thread.sleep(20000);
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking for return segment", "Clicking on return segment ", true, "Same as Expected", "Return segment is selected", "Return segment should be selected");
	
	
	driver.findElement(By.xpath(".//*[@class='button_continue_lmd']")).click();
	Thread.sleep(9000);
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking for back to listing button", "Clicking on back to listing button ", true, "Same as Expected", "Back to listing button is clicked", "Back to listing button should be selected");
	
	
	
	driver.findElement(By.xpath("//a[@onclick='deselectChooseDepOrArrival();']")).click();
	Thread.sleep(8000);
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking for Deselect button", "Clicking on Deselect button ", true, "Same as Expected", "Deselect button is clicked", "Deselect button should be selected");
	
	driver.findElement(By.xpath(".//*[@id='productListViewLink']/a")).click();
	Thread.sleep(9000);
	excelreadwrite.insertData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Checking for Product View option ", "Clicking on Product View option  ", true, "Same as Expected", "Product View option button is clicked", "Product View option  should be selected");
	...
	{
		excelreadwrite.insertFailedData(currentTestName, commonUtility.getcurrentDateTime(), "Time Bar Functionality for Departure of RT product", "Verify whether Timebar option is available ", "Timebar option is not available", true, "Not Same as Expected", "Timebar option is not available", "Timebar option should be available");
