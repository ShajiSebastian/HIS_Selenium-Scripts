...
public class TC_SA_VerifyProductInformationBasicListingPage_JS_OW extends DriverSetup {
	...
	public void setup() {				
		...
		System.out.println("***TC_SA_VerifyProductInformationBasicListingPage_JS_OW***");
	...
	@DataProvider(name = "TC_SA_VerifyProductInformationBasicListingPage_JS_OW")
	public Object[][] createData2() throws Exception {
		...
		Object[][] retObjArr = excelRead.getTableArray(path, "TC",
				"TC_SA_VerifyProductInformationBasicListingPage_JS_OW");
	...
	@Test(dataProvider = "TC_SA_VerifyProductInformationBasicListingPage_JS_OW")
	public void ProductInfoBasicListingStore(String ToCity1, String Depart1, String NoOfAdults, String NoOfChild,
		...
		try {
			...
			driver.findElement(By.xpath(".//*[@id='searchTypeId'][2]")).click();
			System.out.println("Going to click OW option");

			System.out.println("page refreshed");

			System.out.println("OW search option selected by default");
			driver.findElement(By.xpath(".//*[@id='searchTypeId'][2]")).click();
						...
						for(airlineCount=3; airlineCount<= c; ) 
							 	{
									...
									System.out.println("Expected Destination: " +ToCity1);
