...
public class TC_SalesPage_OUMode  extends DriverSetup {
	...
	public void setup() {				
		...
		test  = extent.startTest("Sales Page");		
	
	}
	
		
	@DataProvider(name = "TC_SalesPage_OUMode")
	...
	@Test(dataProvider = "TC_SalesPage_OUMode")
	public void TC_SEOPage_OUMode(String countryCode, String cityCode,String productID)
		{
		...
		String SalesPgUrl= testURL.concat(countryCode).concat("/").concat(cityCode).concat("/").concat("P").concat(productID).concat("/");
		driver.get(SalesPgUrl)	;	
		Thread.sleep(8000);
		test.log(LogStatus.PASS,"Invoking Sales Page");
        ...
        MyWaitVar60Sec.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='searchFaresBtn']")));
		driver.findElement(By.xpath(".//*[@id='searchFaresBtn']")).click();
		...
		Thread.sleep(20000);
		   ...
		   if(isTrue== true)
		   {
			   ...
			   test.log(LogStatus.PASS,"Product is available");
		   }
